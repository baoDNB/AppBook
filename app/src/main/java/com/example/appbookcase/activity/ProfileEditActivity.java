...
import com.example.appbookcase.databinding.ActivityProfileEditBinding;
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if(result.getResultCode()== Activity.RESULT_OK){
                        ...
                        Toast.makeText(ProfileEditActivity.this, "Cannelled", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if(result.getResultCode()== Activity.RESULT_OK){
                        ...
                        Log.d(TAG, "onActivityResult: Pick from gallery"+imageUri);
                        binding.profileIv.setImageURI(imageUri);
                    }
                    else {
                        Toast.makeText(ProfileEditActivity.this, "Cannelled", Toast.LENGTH_SHORT).show();
